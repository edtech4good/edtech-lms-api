  ...
  down: (queryInterface: QueryInterface) =>
    queryInterface.sequelize.transaction(async (transaction) => {
      return Promise.all([
        ...
        queryInterface.removeColumn("countries", "created_by", {
          transaction,
        }),
        queryInterface.removeColumn("countries", "updated_at", {
          transaction,
        }),
        queryInterface.removeColumn("countries", "updated_by", {
          transaction,
        }),
        queryInterface.removeColumn("countries", "deleted_at", {
          transaction,
        }),
        queryInterface.removeColumn("countries", "deleted_by", {
          transaction,
        }),
      ]);
    }),
