...
/** Align new tables with `curriculums.curriculumid` (Docker vs legacy collations). */
...
/** Collation of an existing column (for FK compatibility across mixed-migration DBs). */
